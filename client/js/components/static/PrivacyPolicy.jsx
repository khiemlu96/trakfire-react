...
var PrivacyPolicy = React.createClass({
  ...
  render: function() {
    return (
      <div className="container p-t-md privacy-policy">
	<span className="tf-static-page-header">PRIVACY POLICY</span>
<section>
Last Updated: January 1, 2016.

This privacy policy (“Policy”) describes how TrakFire Inc. and its related companies (“Company”) collect, use and share personal information of consumer users of this website, www.trakfire.com (the “Site”). This Policy also applies to any of our other websites that post this Policy. This Policy does not apply to websites that post different statements.
...
We may share information to protect the rights and property of TrakFire Inc., our agents, customers, and others. This includes enforcing our agreements, policies, and terms of use.
...
<h5>CONTACT INFORMATION</h5> We welcome your comments or questions about this privacy policy. You may also contact us at our address:

TrakFire Inc.
10351 W Washington Blvd
Culver City, California 90232

<h5>CHANGES TO THIS PRIVACY POLICY</h5> We may change this privacy policy. If we make any changes, we will change the Last Updated date above.
</section>
      </div>
    );
  },
